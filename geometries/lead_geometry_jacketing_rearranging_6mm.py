...
mesh_dir = "/geomDir"
mesh_name = "/leadJacketedRearranged6mm"
...
wireJacket, _ = wireGenerator(0,0,0,0,0,l_lead, r_lead_nojacket, r_lead, removeTool=True)

# # Power domain generation
powerCopper, powerJacket = wireGenerator(2*r_power/np.sqrt(3), 0, 0, 0, 0, l_lead, r_copper_power, r_power)
...
# signalCopper3, signalJacket3 = wireGenerator(r_lead_nojacket-r_signal, 0, 0, 0, 0, l_lead, r_copper_signal, r_signal)

# start_angle_signal = np.pi/180*38
...
# start_angle_signal2 = np.pi/180*60
...
# start_angle_signal3 = np.pi/180*82
...
# # middle layer
# start_angle_signal4 = np.pi/180*44
# signalCopper4, signalJacket4 = wireGenerator(r_lead_nojacket-3*r_signal, 0, 0, 0, 0, l_lead, r_copper_signal, r_signal)
# gmsh.model.occ.rotate(signalCopper4, 0, 0, 0, 0, 0, 1, start_angle_signal4)
# gmsh.model.occ.rotate(signalJacket4, 0, 0, 0, 0, 0, 1, start_angle_signal4)
# copyAndRotate(signalCopper4, start_angle, N_signal)
# copyAndRotate(signalJacket4, start_angle, N_signal)
# gmsh.model.occ.synchronize()

# start_angle_signal5 = np.pi/180*76
# signalCopper5, signalJacket5 = wireGenerator(r_lead_nojacket-3*r_signal, 0, 0, 0, 0, l_lead, r_copper_signal, r_signal)
# gmsh.model.occ.rotate(signalCopper5, 0, 0, 0, 0, 0, 1, start_angle_signal5)
# gmsh.model.occ.rotate(signalJacket5, 0, 0, 0, 0, 0, 1, start_angle_signal5)
# copyAndRotate(signalCopper5, start_angle, N_signal)
# copyAndRotate(signalJacket5, start_angle, N_signal)
# gmsh.model.occ.synchronize()
