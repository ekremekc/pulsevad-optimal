...
# gmsh.model.occ.addPipe([(2, 1), (2, 2)], 1, 'ConstantNormal')
# gmsh.model.occ.addPipe([(2, 1), (2, 2)], 1, 'CorrectedFrenet')
# gmsh.model.occ.addPipe([(2, 1), (2, 2)], 1, 'GuideAC')
# gmsh.model.occ.addPipe([(2, 1), (2, 2)], 1, 'GuidePlan')
# gmsh.model.occ.addPipe([(2, 1), (2, 2)], 1, 'GuideACWithContact')
# gmsh.model.occ.addPipe([(2, 1), (2, 2)], 1, 'GuidePlanWithContact')
# gmsh.model.occ.addPipe([(2, 1), (2, 2)], 1, 'Fixed')
# gmsh.model.occ.addPipe([(2, 1), (2, 2)], 1, 'Darboux')
